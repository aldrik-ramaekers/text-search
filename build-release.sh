...
gcc -Wall -O3 -m64 -Wno-unused-label -DFREE_TRIAL -rdynamic -Wno-unused-variable text_search.c -o ../release/linux/text-search_x64_linux_trial -lX11 -lGL -lGLU -lXrandr -lm -lpthread -ldl
