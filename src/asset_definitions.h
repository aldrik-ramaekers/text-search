...
#ifndef INCLUDE_ASSET_DEFINITIONS
#define INCLUDE_ASSET_DEFINITIONS

extern unsigned char _binary____data_imgs_en_bmp_start[];
extern unsigned char _binary____data_imgs_en_bmp_end[];

extern unsigned char _binary____data_imgs_error_bmp_start[];
extern unsigned char _binary____data_imgs_error_bmp_end[];

extern unsigned char _binary____data_imgs_folder_bmp_start[];
extern unsigned char _binary____data_imgs_folder_bmp_end[];

extern unsigned char _binary____data_imgs_nl_bmp_start[];
extern unsigned char _binary____data_imgs_nl_bmp_end[];

extern unsigned char _binary____data_imgs_search_bmp_start[];
extern unsigned char _binary____data_imgs_search_bmp_end[];
